...
print(f"Processing complete GO {aspect} Elastic Net coefficients with cutoff {cutoff}...\n")
...
print(f"Complete GO {aspect} Elastic Net coefficients with cutoff {cutoff} ready!")