...
print("Processing complete HDO coefficients plotting...\n")
...
plt.title(f'Top complete HDO full Elastic Net Coefficients (Green = Positive, Red = Negative)')
...
print("Top coefficients plotted!\n")

print("Plotting coefficients distribution...\n")
...
print("Coefficient distribution plotted!\n")

print("Complete HDO coefficients plotting done!")