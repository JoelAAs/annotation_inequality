...
print(f"Processing top GO {aspect} coefficients depth {depth} cutoff {cutoff} annotated neighbors correlation with baseline...")
...
print(f"Computing top GO {aspect} coefficients depth {depth} cutoff {cutoff} annotated neighbors correlation with baseline...")
...
print(f"Saving results for top GO {aspect} coefficients annotated neighbors depth {depth} cutoff {cutoff}...")

summary_df = pd.DataFrame(results)
summary_df.to_csv(outputstats, sep = '\t', index = False)

print(f"Top GO {aspect} coefficients depth {depth} cutoff {cutoff} annotated neighbors correlation with baseline ready!")