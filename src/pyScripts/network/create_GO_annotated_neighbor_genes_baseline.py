...
print(f"Building annotated neighbors baseline for GO {aspect} top coefficients depth {depth} cutoff {cutoff}...")
...
print(f"Processing GO {aspect} top coefficients depth {depth} cutoff {cutoff} annotated neighbors baseline...")
...
print(f"GO {aspect} top coefficients depth {depth} cutoff {cutoff} annotated neighbors baseline processed!")

print(f"Saving GO {aspect} top coefficients depth {depth} cutoff {cutoff} annotated neighbors baseline...")
...
print(f"GO {aspect} top coefficients depth {depth} cutoff {cutoff} annotated neighbors baseline saved!")

print(f"Annotated neighbors baseline for GO {aspect} top coefficients depth {depth} cutoff {cutoff} ready!")
