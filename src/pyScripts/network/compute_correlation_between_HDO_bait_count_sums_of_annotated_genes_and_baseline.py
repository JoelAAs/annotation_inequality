...
print(f"Processing top HDO coefficients depth {depth} cutoff {cutoff} correlation with baseline...")
...
print(f"Computing top HDO coefficients depth {depth} cutoff {cutoff} correlation with baseline...")
...
print(f"Saving results for top HDO coefficients depth {depth} cutoff {cutoff}...")

summary_df = pd.DataFrame(results)
summary_df.to_csv(outputstats, sep = '\t', index = False)

print(f"Top HDO coefficients depth {depth} cutoff {cutoff} correlation with baseline ready!")