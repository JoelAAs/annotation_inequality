...
ax.set_title(f"Distribution of GO {aspect} Neighbor Sums (Log Scale)", loc = 'left', fontweight='bold', fontsize = 26, pad = 25)
ax.set_ylabel("Neighbors Bait Count Sum (log scale)", fontsize = 22, labelpad = 20)
ax.set_xlabel(f"GO {aspect} Annotation", fontsize = 22, labelpad = 20)
