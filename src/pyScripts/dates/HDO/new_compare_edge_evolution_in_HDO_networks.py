...
print(f"Computing Node-Centric Mean Fractions (True Historian Logic) for HDO depth {depth} cutoff {cutoff}...")
...
print("Node-Centric Mean Time-Zero statistics ready for HDO!")