...
print(f"Computing Full Time-Zero (True Historian Logic) statistics for HDO depth {depth} cutoff {cutoff}...")
...
print(f"HDO Full Time-Zero (True Historian) statistics ready!")