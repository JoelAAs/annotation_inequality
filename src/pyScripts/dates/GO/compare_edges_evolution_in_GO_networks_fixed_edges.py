...
print(f"Computing Edge-Centric Mean Fractions (RETROSPECTIVE Logic) for GO {aspect} depth {depth} cutoff {cutoff}...")
...
print("Edge-Centric Mean Time-Zero statistics ready for GO (Retrospective)!")