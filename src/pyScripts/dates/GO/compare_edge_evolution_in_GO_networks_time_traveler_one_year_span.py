...
print(f"Computing Time-Traveler 24-Month Window statistics for GO {aspect} depth {depth} cutoff {cutoff}...")
...
for index, row in top_annot.iterrows():
    ...
    for target_node in genes:
        ...
        for neighbor in G.neighbors(target_node):
            ...
            is_annotated = get_annotation_date(neighbor, go_id) is not None
...
print(f"Time-Traveler 24-Month statistics ready!")