...
print(f"Generating multi-page PDF for HDO depth {depth} cutoff {cutoff} neighbors bait count sums...\n")

print(f"Loading data for HDO depth {depth} cutoff {cutoff} neighbors bait count sums...")

with open(neighbors_sums_df, 'rb') as f:
    df = pickle.load(f)

print(f"HDO depth {depth} cutoff {cutoff} neighbors bait count sums data loaded!\n")

print(f"Plotting HDO depth {depth} cutoff {cutoff} neighbors bait count sums...")
...
print(f"HDO depth {depth} cutoff {cutoff} neighbors bait count sums plotted!\n")

print(f"Multi-page PDF for HDO depth {depth} cutoff {cutoff} neighbors bait count sums ready!\n")