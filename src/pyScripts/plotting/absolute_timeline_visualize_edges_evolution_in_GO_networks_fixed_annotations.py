...
print(f"Plotting absolute timeline edges evolution with fixed annotations for GO {aspect} network...")
...
plt.title(f"Historical {onto_label} Network Evolution\n(Fixed Annotations | Daily Precision | Depth: {depth} - Cutoff: {cutoff})", fontsize=24, fontweight='bold', pad=25)
...
print(f"Absolute timeline edges evolution plot with fixed annotations for GO {aspect} network ready!")