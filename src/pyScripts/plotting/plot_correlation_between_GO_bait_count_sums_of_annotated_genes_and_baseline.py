...
ax1.set_title(f"A. Mean GO {aspect} Neighbor Bait Counts (Paired Wilcoxon)", loc = 'left', fontweight = 'bold')
...
ax2.set_yscale('log')
ax2.set_title(f"B. Distribution of GO {aspect} Neighbor Sums (Log Scale)", loc = 'left', fontweight='bold')
ax2.set_ylabel("Neighbors Bait Count Sum (log - scale)")
ax2.set_xlabel(f"GO {aspect} Annotation")
