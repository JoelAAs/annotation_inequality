...
ax1.set_title(f"A. Mean HDO Annotated Neighbors (Paired Wilcoxon)", loc = 'left', fontweight = 'bold')
...
ax2.set_yscale('log')
ax2.set_title(f"B. Distribution of HDO Annotated Neighbors (Log Scale)", loc = 'left', fontweight='bold')
ax2.set_ylabel("Annotated neighbors (log - scale)")
